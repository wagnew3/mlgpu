...
public class JCudaReduction
{
    ...
    public static void main(String args[])
    {
        ...
        for (int n = 5; n <= 10; n *= 2)
        {
            ...
            System.out.println("Reduction of " + n + " elements: "+Arrays.toString(hostInput));
            System.out.printf(
     ...
     */
    static float reduceHost(float data[])
    {
        float sum = data[0];
        float c = 0.0f;              
    ...
    private static float[] createRandomArray(int size)
    {
        ...
        {
            array[i] = (float) (random.nextFloat()*(Math.random()-0.5));
        }
        return array;
    }
